...
namespace Carmelita\FirstProject\Services;

use Carmelita\FirstProject\Kernel\Auth\User;
use Carmelita\FirstProject\Kernel\Database\DatabaseInterface;
use Carmelita\FirstProject\Models\Movie;
use Carmelita\FirstProject\Models\Review;
